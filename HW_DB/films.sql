...
CREATE TABLE `films` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UC_films` (`title`,`year`)
...
INSERT INTO `films` VALUES (5,'A Nightmare on Elm Street',1984),(6,'A Nightmare on Elm Street 2: Freddys Revenge',1985),(1,'Alien',1979),(4,'Alien Resurrection',1997),(3,'Alien3',1992),(2,'Aliens',1986);
...
CREATE TABLE `films_persons` (
  ...
  UNIQUE KEY `UC_films_persons` (`film_id`,`person_id`,`person_profile`)
...
INSERT INTO `films_persons` VALUES (1,1,'director'),(1,2,'producer'),(1,3,'producer'),(1,4,'producer'),(1,5,'screenwriter'),(1,6,'screenwriter'),(1,7,'operator'),(1,8,'actor'),(1,9,'actor'),(2,2,'producer'),(2,3,'producer'),(2,3,'screenwriter'),(2,4,'producer'),(2,4,'screenwriter'),(2,9,'actor'),(2,10,'director'),(2,10,'screenwriter'),(2,11,'actor'),(2,12,'operator'),(3,2,'producer'),(3,3,'producer'),(3,3,'screenwriter'),(3,4,'producer'),(3,4,'screenwriter'),(3,9,'actor'),(3,13,'director'),(3,14,'screenwriter'),(3,15,'actor'),(3,16,'operator'),(4,2,'producer'),(4,3,'producer'),(4,4,'producer'),(4,9,'actor'),(4,17,'director'),(4,18,'screenwriter'),(4,19,'actor'),(4,20,'actor'),(4,21,'operator'),(5,22,'director'),(5,22,'screenwriter'),(5,23,'producer'),(5,24,'actor'),(5,25,'actor'),(5,26,'actor'),(5,27,'operator'),(6,22,'screenwriter'),(6,23,'producer'),(6,26,'actor'),(6,27,'operator'),(6,28,'director'),(6,29,'actor'),(6,30,'actor');
...
CREATE TABLE `films_series` (
  ...
  UNIQUE KEY `UC_films_series` (`film_id`,`series_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `series` VALUES (2,'A Nightmare on Elm Street'),(1,'Alien');
...
-- Dump completed on 2019-07-18 17:48:23
